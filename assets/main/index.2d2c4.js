window.__require = function e(t, n, r) {
  ...
  AudioManager: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "6bbdfdarJ5CSIGkH6GqT27K", "AudioManager");
    "use strict";
    ...
    var AudioManager = cc.Class({
      ...
      MusicVolume: function MusicVolume() {
  ...
  Game: [ function(require, module, exports) {
    ...
    var Game = cc.Class({
      ...
      showBoxMusic: function showBoxMusic() {
        AudioManager.instance.PlaySFX("button");
        this.Box = !this.Box;
        this.Box ? this.boxSound.active = true : this.boxSound.active = false;
      },
        ...
        if (enter) {
          ...
          switch (outcome) {
           case Types.Outcome.Win:
            ...
            AudioManager.instance.PlaySFX("SoundWin");
            this.totalChipsNum += this.player.stakeNum;
           ...
           case Types.Outcome.Lose:
            ...
            AudioManager.instance.StopMusic("BackgroundMusic");
            AudioManager.instance.PlaySFX("SoundLose");
            break;
  ...
  sound: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "fcd27CD7wdFU521wHeg25Uo", "sound");
    "use strict";
    var Sound = cc.Class({
      properties: {
        n: {
  ...
  "use_v2.1-2.2.1_cc.Toggle_event": [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "9c3acl43EZA5ZaO9wjAIZfK", "use_v2.1-2.2.1_cc.Toggle_event");
    "use strict";
    cc.Toggle && (cc.Toggle._triggerEventInScript_isChecked = true);
    cc._RF.pop();
  }, {} ]
}, {}, [ "use_v2.1-2.2.1_cc.Toggle_event", "Actor", "ActorRenderer", "AssetMng", "AudioManager", "AudioMng", "Bet", "Card", "Dealer", "FXPlayer", "Game", "Menu", "Player", "SideSwitcher", "TossChip", "ButtonScaler", "InGameUI", "ModalUI", "RankItem", "RankList", "state.com", "Decks", "PlayerData", "Types", "Utils", "game-fsm", "sound" ]);